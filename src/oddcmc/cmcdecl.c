...
#define oCMC_DECL_LIST_                                                \
   ...
   \
   XMAP_C_( O_CmcInfo, "Info", 0x1, mand_, single_, o_EbmlMaster ) \
   \
   ...
   \
   XMAP_C_( O_CmcCreators, "Creators", 0x1, opt_, single_, o_EbmlMaster ) \
   XMAP_C_( O_CmcCreator, "Creator", 0x1, mand_, mult_, o_EbmlMaster ) \
   ...
   \
   XMAP_C_( O_CmcIssues, "Issues", 0x1, opt_, single_, o_EbmlMaster ) \
   ...
   \
   XMAP_C_( O_CmcStories, "Stories", 0x1, opt_, single_, o_EbmlMaster ) \
   ...
   \
   XMAP_C_( O_CmcPages, "Pages", 0x1, mand_, single_, o_EbmlMaster ) \
